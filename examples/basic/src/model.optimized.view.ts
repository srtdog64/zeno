...
export class UserView extends ProjectionView {
  ...
  private $idOffset = 0;
  private $ageOffset = 8;
  private $scoreOffset = 16;
  private $ratioOffset = 24;
  ...
  private $refreshOffsets(): void {
    this.$idOffset = this.baseOffset + 0;
    this.$ageOffset = this.baseOffset + 8;
    this.$scoreOffset = this.baseOffset + 16;
    this.$ratioOffset = this.baseOffset + 24;
  }
  ...
  moveTo(index: number): this {
    this.moveToIndex(index, UserView.byteLength);
    this.$refreshOffsets();
    return this;
  }
  ...
  get id(): bigint {
    return this.view.getBigUint64(this.$idOffset, this.littleEndian);
  }
  set id(value: bigint) {
    this.view.setBigUint64(this.$idOffset, value, this.littleEndian);
  }
  ...
  get age(): number {
    return this.view.getInt32(this.$ageOffset, this.littleEndian);
  }
  set age(value: number) {
    this.view.setInt32(this.$ageOffset, value, this.littleEndian);
  }
  ...
  get score(): number {
    return this.view.getFloat64(this.$scoreOffset, this.littleEndian);
  }
  set score(value: number) {
    this.view.setFloat64(this.$scoreOffset, value, this.littleEndian);
  }
  ...
  get ratio(): number {
    return this.view.getFloat32(this.$ratioOffset, this.littleEndian);
  }
  set ratio(value: number) {
    this.view.setFloat32(this.$ratioOffset, value, this.littleEndian);
  }
